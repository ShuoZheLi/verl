#!/bin/bash
#SBATCH --job-name=high_ent_critic_step400_seed137
...
# Run identity
# -----------------------------
RUN_NAME="high_ent_critic_step400_seed137"
...
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/high_ent_critic_training_ckpt_100_actor_697771/train_log/global_step_400"
...
OUTPUT_DIR="${RUN_DIR}/high_ent_critic400_seed137"
