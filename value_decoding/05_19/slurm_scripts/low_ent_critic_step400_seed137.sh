#!/bin/bash
#SBATCH --job-name=low_ent_critic_step400_seed137
...
# Run identity
# -----------------------------
RUN_NAME="low_ent_critic_step400_seed137"
...
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/low_ent_critic_training_ckpt_750_actor_697767/train_log/global_step_400"
...
OUTPUT_DIR="${RUN_DIR}/low_ent_critic400_seed137"
