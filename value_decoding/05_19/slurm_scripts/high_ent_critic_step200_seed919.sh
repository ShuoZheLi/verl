#!/bin/bash
#SBATCH --job-name=high_ent_critic_step200_seed919
...
# Run identity
# -----------------------------
RUN_NAME="high_ent_critic_step200_seed919"
RUN_ID="${RUN_NAME}_${SLURM_JOB_ID}"

# -----------------------------
# Paths
# -----------------------------
ACTOR_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/high_ent_critic_training_ckpt_100_actor_697771/train_log/global_step_600"
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/high_ent_critic_training_ckpt_100_actor_697771/train_log/global_step_200"
...
OUTPUT_DIR="${RUN_DIR}/high_ent_critic200_seed919"
