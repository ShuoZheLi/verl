#!/bin/bash
#SBATCH --job-name=ppo_ckpt_step150_seed137
...
# Run identity
# -----------------------------
RUN_NAME="ppo_ckpt_step150_seed137"
...
ACTOR_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/qwen2.5_7B_ppo_664998/global_step_150"
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/qwen2.5_7B_ppo_664998/global_step_150"
...
OUTPUT_DIR="${RUN_DIR}/ppo_step150_seed137"
