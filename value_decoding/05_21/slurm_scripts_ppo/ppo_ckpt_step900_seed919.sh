#!/bin/bash
#SBATCH --job-name=DEV_ppo_ckpt_step900_seed919
...
#SBATCH --output=DEV_slurm-%j.out
#SBATCH --error=DEV_slurm-%j.err
...
# Run identity
# -----------------------------
RUN_NAME="ppo_ckpt_step900_seed919"
...
ACTOR_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/qwen2.5_7B_ppo_664998/global_step_900"
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/qwen2.5_7B_ppo_664998/global_step_900"
...
OUTPUT_DIR="${RUN_DIR}/ppo_step900_seed919"
