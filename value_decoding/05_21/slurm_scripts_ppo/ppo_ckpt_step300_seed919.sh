#!/bin/bash
#SBATCH --job-name=ppo_ckpt_step300_seed919
...
# Run identity
# -----------------------------
RUN_NAME="ppo_ckpt_step300_seed919"
...
ACTOR_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/qwen2.5_7B_ppo_664998/global_step_300"
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/qwen2.5_7B_ppo_664998/global_step_300"
...
OUTPUT_DIR="${RUN_DIR}/ppo_step300_seed919"
