...
#SBATCH --time=3:20:00
#SBATCH --output=slurm-%j_critic_test_metrics_seed_42_111_222.out
#SBATCH --error=slurm-%j_critic_test_metrics_seed_42_111_222.err
...
OUTPUT_ROOT="${RUN_DIR}/critic_test_metrics_math500"
