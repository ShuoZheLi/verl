...
6 critic checkpoints × 3 seeds = 18 jobs
- search_induced_critic checkpoints: steps 1000, 1500, 2000, 2500, 3000, 3500
- Single low-entropy actor for all jobs (same as previous run)
- Seeds: 42, 123, 456
- chunk_sizes: 128 256
"""
...
ACTOR_DIR = "/scratch/10587/npg493/verl_runs/lowent_critic_cont_725937/train_log/global_step_200"

CRITIC_BASE = "/scratch/10587/npg493/value_decoding_runs/search_induced_critic_training_730003/search_induced_critic_training/checkpoints"
CRITIC_STEPS = [1000, 1500, 2000, 2500, 3000, 3500]

OUTPUT_SCRIPTS_DIR = "job_scripts_search_induced"
...
for step in CRITIC_STEPS:
    critic_dir = f"{CRITIC_BASE}/step_{step:06d}"

    for seed in SEEDS:
        run_name      = f"chunk_guidance_eval_7b_search_induced_critic_step{step}_seed{seed}"
        job_name      = run_name
