#!/bin/bash
#SBATCH --job-name=chunk_guidance_eval_7b_search_induced_critic_step2000_seed123
...
#SBATCH --output=slurm-%j_chunk_guidance_eval_7b_search_induced_critic_step2000_seed123.out
#SBATCH --error=slurm-%j_chunk_guidance_eval_7b_search_induced_critic_step2000_seed123.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_eval_7b_search_induced_critic_step2000_seed123"
...
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/value_decoding_runs/search_induced_critic_training_730003/search_induced_critic_training/checkpoints/step_002000"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_eval_7b_search_induced_critic_step2000_seed123"
