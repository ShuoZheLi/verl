#!/bin/bash
#SBATCH --job-name=chunk_guidance_eval_7b_search_induced_critic_step1500_seed456
...
#SBATCH --output=slurm-%j_chunk_guidance_eval_7b_search_induced_critic_step1500_seed456.out
#SBATCH --error=slurm-%j_chunk_guidance_eval_7b_search_induced_critic_step1500_seed456.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_eval_7b_search_induced_critic_step1500_seed456"
RUN_ID="${RUN_NAME}_${SLURM_JOB_ID}"

# -----------------------------
# Paths
# -----------------------------
ACTOR_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/lowent_critic_cont_725937/train_log/global_step_200"
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/value_decoding_runs/search_induced_critic_training_730003/search_induced_critic_training/checkpoints/step_001500"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_eval_7b_search_induced_critic_step1500_seed456"
