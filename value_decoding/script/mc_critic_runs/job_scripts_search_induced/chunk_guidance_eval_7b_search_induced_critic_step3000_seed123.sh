#!/bin/bash
#SBATCH --job-name=chunk_guidance_eval_7b_search_induced_critic_step3000_seed123
...
#SBATCH --output=slurm-%j_chunk_guidance_eval_7b_search_induced_critic_step3000_seed123.out
#SBATCH --error=slurm-%j_chunk_guidance_eval_7b_search_induced_critic_step3000_seed123.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_eval_7b_search_induced_critic_step3000_seed123"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_eval_7b_search_induced_critic_step3000_seed123"
