#!/bin/bash
#SBATCH --job-name=chunk_guidance_eval_7b_search_induced_critic_step3000_seed42
...
#SBATCH --output=slurm-%j_chunk_guidance_eval_7b_search_induced_critic_step3000_seed42.out
#SBATCH --error=slurm-%j_chunk_guidance_eval_7b_search_induced_critic_step3000_seed42.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_eval_7b_search_induced_critic_step3000_seed42"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_eval_7b_search_induced_critic_step3000_seed42"
