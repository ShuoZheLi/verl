#!/bin/bash
#SBATCH --job-name=train_collect_search_data
...
#SBATCH --output=slurm-%j_ppo_actor_850_induced_critic_data_500.out
#SBATCH --error=slurm-%j_ppo_actor_850_induced_critic_data_500.err
set -euo pipefail
# -----------------------------
# Environment setup
# -----------------------------
...
# Paths
# -----------------------------
ACTOR_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/qwen2.5_7B_ppo_664998/global_step_850/actor"
COLLECTOR_CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/qwen2.5_7B_ppo_664998/global_step_850/critic"
DATASET_PATH="/scratch/10587/npg493/dataset/MetaMathQA-math-500/train.parquet"
...
summary = {
    ...
    "group_level": {
        ...
        "mean_group_collector_top1_reward": mean(group["group_collector_top1_reward"] for group in group_ummaries),
