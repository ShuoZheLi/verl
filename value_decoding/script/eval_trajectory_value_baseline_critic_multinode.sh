...
CRITIC_CHECKPOINT_DIRS="/work2/09576/shuozhe/verl/train_log/job_05b_vh_init_e5_metamath/global_step_800"

# --- Data ---------------------------------------------------------------------
DATASET_PATH="/work2/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet"
ARCHIVE_DIR="/work2/09576/shuozhe/verl/value_decoding/output/trajectory_value_baseline_critic_multinode/${SLURM_JOB_ID:-manual}"
PROMPT_KEY="prompt"
