#!/bin/bash
#SBATCH --job-name=chunk_guidance_eval_1d5b_256_seed_42
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_eval_1d5b_256_seed_42"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_eval_1d5b_256_seed_42"
