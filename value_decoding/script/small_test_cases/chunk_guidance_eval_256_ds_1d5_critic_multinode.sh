...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_eval_7b_testset"
RUN_ID="${RUN_NAME}_${SLURM_JOB_ID}"

# -----------------------------
# Paths
# -----------------------------
ACTOR_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/7b_testset_678996/train_log/global_step_75"
CRITIC_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/7b_testset_678996/train_log/global_step_75"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_eval_7b_testset"
