#!/bin/bash
#SBATCH --job-name=chunk_guidance_eval_7b_highent_critic_step600_seed123
...
#SBATCH --output=slurm-%j_chunk_guidance_eval_7b_highent_critic_step600_seed123.out
#SBATCH --error=slurm-%j_chunk_guidance_eval_7b_highent_critic_step600_seed123.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_eval_7b_highent_critic_step600_seed123"
...
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/highent_critic_cont_725939/train_log/global_step_600"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_eval_7b_highent_critic_step600_seed123"
