#!/bin/bash
#SBATCH --job-name=chunk_guidance_eval_7b_lowent_critic_step400_seed456
...
#SBATCH --output=slurm-%j_chunk_guidance_eval_7b_lowent_critic_step400_seed456.out
#SBATCH --error=slurm-%j_chunk_guidance_eval_7b_lowent_critic_step400_seed456.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_eval_7b_lowent_critic_step400_seed456"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_eval_7b_lowent_critic_step400_seed456"
