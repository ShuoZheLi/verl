#!/bin/bash
#SBATCH --job-name=chunk_guidance_eval_7b_lowent_critic_step200_seed456
...
#SBATCH --output=slurm-%j_chunk_guidance_eval_7b_lowent_critic_step200_seed456.out
#SBATCH --error=slurm-%j_chunk_guidance_eval_7b_lowent_critic_step200_seed456.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_eval_7b_lowent_critic_step200_seed456"
...
CRITIC_CHECKPOINT_DIR="/scratch/10587/npg493/verl_runs/lowent_critic_cont_725937/train_log/global_step_200"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_eval_7b_lowent_critic_step200_seed456"
