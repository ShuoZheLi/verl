#!/bin/bash
#SBATCH --job-name=qw2_1d5b_inst_best_n_1500
...
#SBATCH --time=4:00:00
#SBATCH --output=slurm-%j_qw2_1d5b_inst_best_n_1500.out
#SBATCH --error=slurm-%j_qw2_1d5b_inst_best_n_1500.err
...
# Run identity
# -----------------------------
RUN_NAME="best_of_n_Qwen2.5_1d5B_7b_critic_k_8_1500"
...
OUTPUT_DIR="${RUN_DIR}/best_of_n_1d5b_7b_critic_1500"
