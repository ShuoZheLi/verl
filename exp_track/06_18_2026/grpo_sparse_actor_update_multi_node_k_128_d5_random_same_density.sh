#!/bin/bash
#SBATCH --job-name=grpo_1d5_sparse_actor_update_multi_node_k_128_d5_random_same_density
...
#SBATCH --output=slurm-%j_grpo_1d5_sparse_actor_update_multi_node_k_128_d5_random_same_density.out
#SBATCH --error=slurm-%j_grpo_1d5_sparse_actor_update_multi_node_k_128_d5_random_same_density.err
...
# Run identity
# -----------------------------
RUN_NAME="grpo_1d5_sparse_actor_update_multi_node_k_128_d5_random_same_density"
...
# -----------------------------
SPARSE_UPDATE_MODE="${SPARSE_UPDATE_MODE:-random_same_density}"
