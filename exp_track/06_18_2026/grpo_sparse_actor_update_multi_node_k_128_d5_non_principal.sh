#!/bin/bash
#SBATCH --job-name=grpo_1d5_sparse_actor_update_multi_node_k_128_d5_non_principal
...
#SBATCH --output=slurm-%j_grpo_1d5_sparse_actor_update_multi_node_k_128_d5_non_principal.out
#SBATCH --error=slurm-%j_grpo_1d5_sparse_actor_update_multi_node_k_128_d5_non_principal.err
...
# Run identity
# -----------------------------
RUN_NAME="grpo_1d5_sparse_actor_update_multi_node_k_128_d5_non_principal"
...
# -----------------------------
SPARSE_UPDATE_MODE="${SPARSE_UPDATE_MODE:-non_principal}"
