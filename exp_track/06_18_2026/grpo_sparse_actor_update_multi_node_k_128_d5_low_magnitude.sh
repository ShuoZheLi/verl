#!/bin/bash
#SBATCH --job-name=grpo_1d5_sparse_actor_update_multi_node_k_128_d5_low_magnitude
...
#SBATCH --output=slurm-%j_grpo_1d5_sparse_actor_update_multi_node_k_128_d5_low_magnitude.out
#SBATCH --error=slurm-%j_grpo_1d5_sparse_actor_update_multi_node_k_128_d5_low_magnitude.err
...
# Run identity
# -----------------------------
RUN_NAME="grpo_1d5_sparse_actor_update_multi_node_k_128_d5_low_magnitude"
...
# -----------------------------
SPARSE_UPDATE_MODE="${SPARSE_UPDATE_MODE:-low_magnitude}"
