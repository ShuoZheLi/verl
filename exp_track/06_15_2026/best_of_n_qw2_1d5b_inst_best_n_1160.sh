...
#SBATCH --time=4:00:00
#SBATCH --output=slurm-%j_qw2_1d5b_inst_best_n_1160.out
#SBATCH --error=slurm-%j_qw2_1d5b_inst_best_n_1160.err
...
# Run identity
# -----------------------------
RUN_NAME="best_of_n_Qwen2.5_1d5B_critic_1d5_k_8_1160"
