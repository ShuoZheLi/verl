#!/bin/bash
#SBATCH --job-name=best_of_n_Qw2_3B_base_critic_300
...
#SBATCH --time=4:00:00
#SBATCH --output=slurm-%j_best_of_n_Qw2_3B_base_critic_300.out
#SBATCH --error=slurm-%j_best_of_n_Qw2_3B_base_critic_300.err
...
# Run identity
# -----------------------------
RUN_NAME="best_of_n_Qw2_3B_base_critic_300"
RUN_ID="${RUN_NAME}_${SLURM_JOB_ID}"

# -----------------------------
# Paths
# -----------------------------
ACTOR_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/3b_base_critic_788041/train_log/global_step_300"
CRITIC_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/3b_base_critic_788041/train_log/global_step_300"
...
OUTPUT_DIR="${RUN_DIR}/best_of_n_3B_base_critic_300"
