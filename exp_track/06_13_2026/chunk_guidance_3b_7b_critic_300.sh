#!/bin/bash
#SBATCH --job-name=chunk_guidance_3b_7b_critic_300
...
#SBATCH --output=slurm-%j_chunk_guidance_3b_7b_critic_300.out
#SBATCH --error=slurm-%j_chunk_guidance_3b_7b_critic_300.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_3b_7b_critic_300"
RUN_ID="${RUN_NAME}_${SLURM_JOB_ID}"

# -----------------------------
# Paths
# -----------------------------
ACTOR_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/7b_testset_752951/train_log/global_step_300"
CRITIC_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/7b_testset_752951/train_log/global_step_300"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_3b_7b_critic_300"
