#!/bin/bash
#SBATCH --job-name=chunk_guidance_1d5b_7b_critic_900
...
#SBATCH --output=slurm-%j_chunk_guidance_1d5b_7b_critic_900.out
#SBATCH --error=slurm-%j_chunk_guidance_1d5b_7b_critic_900.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_1d5b_7b_critic_900"
RUN_ID="${RUN_NAME}_${SLURM_JOB_ID}"

# -----------------------------
# Paths
# -----------------------------
ACTOR_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/7b_testset_752950/train_log/global_step_900"
CRITIC_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/7b_testset_752950/train_log/global_step_900"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_1d5b_7b_critic_900"
