#!/bin/bash
#SBATCH --job-name=chunk_guidance_1d5b_7b_critic_300
...
#SBATCH --output=slurm-%j_chunk_guidance_1d5b_7b_critic_300.out
#SBATCH --error=slurm-%j_chunk_guidance_1d5b_7b_critic_300.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_1d5b_7b_critic_300"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_1d5b_7b_critic_300"
