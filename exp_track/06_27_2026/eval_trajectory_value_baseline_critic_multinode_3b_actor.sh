...
#SBATCH --output=slurm-%j_eval_trajectory_value_baseline_critic_multinode_3b_actor.out
#SBATCH --error=slurm-%j_eval_trajectory_value_baseline_critic_multinode_3b_actor.err
...
# --- Checkpoints --------------------------------------------------------------
CHECKPOINT_ROOT="/scratch/09576/shuozhe/verl_runs/Qwen2.5-3B_7b_critic_resume_780634/train_log/"
ACTOR_CHECKPOINT_DIR="${CHECKPOINT_ROOT}/global_step_1200"
CRITIC_CHECKPOINT_DIRS=""
for step in $(seq 1200 100 2300); do
