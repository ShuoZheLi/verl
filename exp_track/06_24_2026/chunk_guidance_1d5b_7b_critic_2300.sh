#!/bin/bash
#SBATCH --job-name=chunk_guidance_1d5b_7b_critic_2300
...
#SBATCH --output=slurm-%j_chunk_guidance_1d5b_7b_critic_2300.out
#SBATCH --error=slurm-%j_chunk_guidance_1d5b_7b_critic_2300.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_1d5b_7b_critic_2300"
RUN_ID="${RUN_NAME}_${SLURM_JOB_ID}"

# -----------------------------
# Paths
# -----------------------------
ACTOR_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/Qwen2.5-1.5B_7b_critic_resume_780633/train_log/global_step_2300"
CRITIC_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/Qwen2.5-1.5B_7b_critic_resume_780633/train_log/global_step_2300"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_1d5b_7b_critic_2300"
