#!/bin/bash
#SBATCH --job-name=chunk_guidance_3b_7b_critic_2300
...
#SBATCH --output=slurm-%j_chunk_guidance_3b_7b_critic_2300.out
#SBATCH --error=slurm-%j_chunk_guidance_3b_7b_critic_2300.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_3b_7b_critic_2300"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_3b_7b_critic_2300"
