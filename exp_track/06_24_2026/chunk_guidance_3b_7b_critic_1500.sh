#!/bin/bash
#SBATCH --job-name=chunk_guidance_3b_7b_critic_1500
...
#SBATCH --output=slurm-%j_chunk_guidance_3b_7b_critic_1500.out
#SBATCH --error=slurm-%j_chunk_guidance_3b_7b_critic_1500.err
...
# Run identity
# -----------------------------
RUN_NAME="chunk_guidance_3b_7b_critic_1500"
RUN_ID="${RUN_NAME}_${SLURM_JOB_ID}"

# -----------------------------
# Paths
# -----------------------------
ACTOR_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/Qwen2.5-3B_7b_critic_resume_780634/train_log/global_step_1500"
CRITIC_CHECKPOINT_DIR="/scratch/09576/shuozhe/verl_runs/Qwen2.5-3B_7b_critic_resume_780634/train_log/global_step_1500"
...
OUTPUT_DIR="${RUN_DIR}/chunk_guidance_3b_7b_critic_1500"
