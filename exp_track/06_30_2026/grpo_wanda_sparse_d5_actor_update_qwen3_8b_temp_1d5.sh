#!/bin/bash
#SBATCH --job-name=grpo_qwen3_8b_wanda_d5_temp_1d5
...
#SBATCH --output=slurm-%j_grpo_qwen3_8b_wanda_d5_temp_1d5.out
#SBATCH --error=slurm-%j_grpo_qwen3_8b_wanda_d5_temp_1d5.err
...
# Run identity
# -----------------------------
RUN_NAME="grpo_qwen3_8b_wanda_sparse_kept_sparsity_d5_temp_1d5"
