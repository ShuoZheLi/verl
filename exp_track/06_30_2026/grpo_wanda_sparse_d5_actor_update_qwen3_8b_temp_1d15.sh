#!/bin/bash
#SBATCH --job-name=grpo_qwen3_8b_wanda_d5_temp_1d15
...
#SBATCH --output=slurm-%j_grpo_qwen3_8b_wanda_d5_temp_1d15.out
#SBATCH --error=slurm-%j_grpo_qwen3_8b_wanda_d5_temp_1d15.err
...
# Run identity
# -----------------------------
RUN_NAME="grpo_qwen3_8b_wanda_sparse_kept_sparsity_d5_temp_1d15"
...
python3 -m verl.trainer.main_ppo \
  ...
  actor_rollout_ref.rollout.temperature=1.15 \
