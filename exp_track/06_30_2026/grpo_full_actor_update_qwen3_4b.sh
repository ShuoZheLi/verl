#!/bin/bash
#SBATCH --job-name=grpo_qwen3_4b_full_update
...
#SBATCH --output=slurm-%j_grpo_qwen3_4b_full_update.out
#SBATCH --error=slurm-%j_grpo_qwen3_4b_full_update.err
...
# Run identity
# -----------------------------
RUN_NAME="grpo_qwen3_4b_full_parameter_update"
...
# -----------------------------
# Full actor update config
# -----------------------------
# This comparison run disables sparse actor updates entirely. No WANDA mask is
# built or loaded, and the actor optimizer updates all parameters that VERL
# normally marks trainable for this model/config.
SPARSE_UPDATE_MASK_OVERRIDES=(
  actor_rollout_ref.actor.sparse_update.enabled=false
)
...
# -----------------------------
# Full-update comparison: no sparse mask build
# -----------------------------
echo "Sparse actor update disabled; using full actor parameter update."
...
echo "SPARSE_UPDATE_ENABLED: false"
echo "Comparison mode: full actor parameter update"
