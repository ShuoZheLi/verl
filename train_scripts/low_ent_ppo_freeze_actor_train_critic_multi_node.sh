#!/bin/bash
#SBATCH --job-name=low_ent_critic_cont
...
POLICY_INIT_CKPT="/scratch/10587/npg493/verl_runs/low_ent_critic_training_ckpt_750_actor_697767/train_log/global_step_640"
CRITIC_INIT_CKPT="/scratch/10587/npg493/verl_runs/low_ent_critic_training_ckpt_750_actor_697767/train_log/global_step_640"
