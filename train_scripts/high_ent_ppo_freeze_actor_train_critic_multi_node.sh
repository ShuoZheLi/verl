#!/bin/bash
#SBATCH --job-name=high_ent_critic_cont
...
export WANDB_PROJECT="shuozhe_ppo"
...
POLICY_INIT_CKPT="/scratch/10587/npg493/verl_runs/high_ent_critic_training_ckpt_100_actor_697771/train_log/global_step_640"
CRITIC_INIT_CKPT="/scratch/10587/npg493/verl_runs/high_ent_critic_training_ckpt_100_actor_697771/train_log/global_step_640"
CRITIC_ONLY_STEPS=1000000000

# TRAIN_FILE="/work2/09576/shuozhe/saved_dataset/MetaMathQA-math-500/train.parquet"
TRAIN_FILE=""/scratch/10587/npg493/dataset/MetaMathQA-math-500/train.parquet""
VAL_FILE=""/scratch/10587/npg493/dataset/MetaMathQA-math-500/test.parquet""
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.project_name="shuozhe_ppo" \
