...
export SLURM_JOB_ID="policy_gs800_dsk_1d5b_critic"

# When true, math_dapo incorrect answers get reward 0.0 instead of -1.0.
MATH_DAPO_BINARY_REWARD=true
POLICY_INIT_CKPT=/data/shuozhe/verl/train_log/job_05b_vh_init_e5_metamath/global_step_800/merged_hf/actor
CRITIC_INIT_CKPT=/data/shuozhe/saved_model/DeepSeek-R1-Distill-Qwen-1.5B
