...
python3 -m verl.trainer.main_ppo \
  data.train_files=/work2/09576/shuozhe/saved_dataset/MetaMathQA-math-500/train.parquet \
  data.val_files=/work2/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet \
